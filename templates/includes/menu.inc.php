<nav class="z-[99999] w-screen flex items-center h-16 md:px-20 bg-white shadow fixed">
        <div class="hidden md:flex gap-12 uppercase text-sm font-bold">
            <a href="./?page=accueil&layout=html">annuaire</a>
            <a href="./?page=auth&layout=html">s'enregistrer</a>
            <a href="./?page=admin&layout=html">gestionnaire</a>
        </div>
        <div class="md:hidden flex items-center">
            ...
            <ul id="mobileMenu" class="hidden w-screen h-screen flex-col space-y-2 pt-16 pl-6 bg-white border shadow absolute top-0 py-2">
                <li><a href="./?page=accueil&layout=html">annuaire</a></li>
                <li><a href="./?page=auth&layout=html">s'enregistrer</a></li>
                <li><a href="./?page=admin&layout=html">gestionnaire</a></li>
            </ul>
        </div>
    </nav>
